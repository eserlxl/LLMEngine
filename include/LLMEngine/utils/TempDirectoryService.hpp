...
class LLMENGINE_EXPORT TempDirectoryService {
  public:
     ...
     */
    [[nodiscard]] static DirectoryResult ensureSecureDirectory(const std::string& directory_path,
     ...
     */
    [[nodiscard]] static bool validatePathWithinRoot(const std::string& requested_path,
     ...
     */
    [[nodiscard]] static bool isDirectoryValid(const std::string& directory_path,
                                               Logger* logger = nullptr);
};
