...
void testChatMessageBuilderWithSystemPrompt() {
    nlohmann::json input = {
        {std::string(LLMEngine::Constants::JsonKeys::SYSTEM_PROMPT), "You are a helpful assistant."}
    };
...
void testChatMessageBuilderWithNumericSystemPrompt() {
    nlohmann::json input = {
        {std::string(LLMEngine::Constants::JsonKeys::SYSTEM_PROMPT), 42}
    };
...
void testChatMessageBuilderWithBooleanSystemPrompt() {
    nlohmann::json input = {
        {std::string(LLMEngine::Constants::JsonKeys::SYSTEM_PROMPT), true}
    };
    std::string prompt = "Test";
