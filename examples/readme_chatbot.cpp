...
public:
    ...
    bool loadReadmeFromUrl(const std::string& url) {
        try {
            ...
            if (response.status_code != 200) {
                std::cerr << "❌ Failed to fetch README. HTTP Status: " << response.status_code << std::endl;
                return false;
            }
            ...
            std::cout << "✅ Successfully loaded README (" << readme_content_.length() << " characters)" << std::endl;
    ...
    bool loadReadmeFromFile(const std::string& filepath) {
        try {
            ...
            std::cout << "✅ Successfully loaded README from file (" << readme_content_.length() << " characters)" << std::endl;
            std::cout << "📋 Project: " << project_name_ << std::endl;
    ...
    void startConversation() {
        ...
        std::cout << "💡 Try: 'help' for commands, 'summary' for project overview, 'quit' to exit" << std::endl;
...
private:
    ...
    std::string createContextPrompt(const std::string& user_question) {
        ...
        prompt << "You are a helpful assistant that answers questions about a software project based on its README file.\n\n";
        ...
        prompt << "Please answer the user's question based on the information provided in the README. ";
        prompt << "If the README doesn't contain enough information to answer the question, please say so. ";
...
void printWelcome() {
    ...
    std::cout << "===================================" << std::endl;
    std::cout << "This chatbot can read GitHub project README files and answer questions about them." << std::endl;
