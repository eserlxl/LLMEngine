...
//
// This example demonstrates translation using LLMEngine and is licensed under
...
class Translator {
  ...
  public:
    ...
    void translateText(const std::string& text,
        ...
        std::cout << "Source: " << (source_language == "auto" ? "Auto-detect" : source_language)
                  << std::endl;
  ...
  private:
    void initializeLanguageMap() {
        language_map_ = {{"en", "English"},     {"es", "Spanish"},    {"fr", "French"},
                         ...
                         {"lt", "Lithuanian"},  {"el", "Greek"},      {"he", "Hebrew"},
                         ...
                         {"az", "Azerbaijani"}, {"kk", "Kazakh"},     {"ky", "Kyrgyz"},
                         {"uz", "Uzbek"},       {"tg", "Tajik"},      {"mn", "Mongolian"},
                         {"bo", "Tibetan"},     {"dz", "Dzongkha"},   {"sw", "Swahili"},
                         {"am", "Amharic"},     {"ti", "Tigrinya"},   {"om", "Oromo"},
                         {"so", "Somali"},      {"ha", "Hausa"},      {"yo", "Yoruba"},
                         {"ig", "Igbo"},        {"zu", "Zulu"},       {"xh", "Xhosa"},
                         {"af", "Afrikaans"},   {"is", "Icelandic"},  {"ga", "Irish"},
                         {"cy", "Welsh"},       {"eu", "Basque"},     {"ca", "Catalan"},
                         {"gl", "Galician"},    {"mt", "Maltese"},    {"mk", "Macedonian"},
                         {"sq", "Albanian"},    {"sr", "Serbian"},    {"bs", "Bosnian"},
                         {"me", "Montenegrin"}, {"uk", "Ukrainian"},  {"be", "Belarusian"},
                         {"md", "Moldovan"},    {"ro", "Romanian"},   {"bg", "Bulgarian"},
                         ...
                         {"tg", "Tajik"},       {"mn", "Mongolian"},  {"bo", "Tibetan"},
                         {"dz", "Dzongkha"},    {"sw", "Swahili"},    {"am", "Amharic"},
                         ...
                         {"mt", "Maltese"},     {"mk", "Macedonian"}, {"sq", "Albanian"},
                         {"sr", "Serbian"},     {"bs", "Bosnian"},    {"me", "Montenegrin"},
                         {"uk", "Ukrainian"},   {"be", "Belarusian"}, {"md", "Moldovan"}};
    }

    std::string buildTranslationPrompt(const std::string& source_language,
                                       const std::string& target_language) {
...
void printUsage() {
    ...
    std::cout << "  ./translator ollama <model> [mode] <text> [target_language] [source_language]"
              << std::endl;
    std::cout
        << "  ./translator ollama <model> [mode] -f <file> <target_language> [source_language]"
        << std::endl;
    std::cout
        << "  ./translator ollama <model> [mode] -d <directory> <target_language> [source_language]"
        << std::endl;
