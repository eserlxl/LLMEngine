...
//
// This example provides a code analyzer tool built with LLMEngine and is
  ...
  public:
    ...
    void analyzeFile(const std::string& filepath,
        ...
        try {
            ...
            nlohmann::json input = {{"code", code}, {"language", language}, {"filepath", filepath}};
    ...
    void compareFiles(const std::string& file1, const std::string& file2) {
        ...
        try {
            std::string prompt = "Compare these two code files and provide a detailed analysis of "
                                 "differences, improvements, and recommendations:";
            nlohmann::json input = {
                {"code1", code1}, {"code2", code2}, {"file1", file1}, {"file2", file2}};
  ...
  private:
    ...
    std::vector<std::string> findCodeFiles(const std::string& dirpath) {
        ...
        std::vector<std::string> extensions = {
            ".cpp", ".cc",  ".cxx", ".c",  ".hpp",   ".h",    ".py",    ".js", ".ts", ".java",
            ".go",  ".rs",  ".php", ".rb", ".swift", ".kt",   ".scala", ".hs", ".ml", ".mli",
            ".fs",  ".fsx", ".cs",  ".vb", ".sh",    ".bash", ".ps1",   ".sql"};
...
void printUsage() {
    ...
    std::cout << "  ./code_analyzer ollama <model> [mode] -d <directory> [analysis_type]"
              << std::endl;
